...
Este repositorio se muestra el proyecto final del Diplomado Automatizacion Industrial y Mecatronica, en la cual consiste en un **Sitema de riego automatizado**, utilizando las herramentas de NodeRed, WOKWI y MySQL
